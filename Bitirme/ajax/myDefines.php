<?php
	...
	*/
	...
	return array(
	    ...
	    'sbSicaklikHeaderNames' => array("Sensör ID","Sıcaklık Değer","Kayıt Zamanı"),
	    'sbSicaklikColonNames' => array("sensor_id","sicaklik_deger","kayit_zamani"),
	    ...
	    'stcSicaklikHeaderNames' => array("Cihaz ID","Sıcaklık Değer","Kayıt Zamanı"),
	    'stcSicaklikColNames' => array("sensor_id","sicaklik_deger","kayit_zamani"),
	    ...
	    'stokColNames' => array("tag_id","ad","doz","stokBirimAd","kullanim_suresi"),
			'homeAlarmHeaderNames' => array("STC No","Başlangıç Zamanı","Ölçülen Sıcaklık","Durum"),
			'homeAlarmColNames' => array("sensor_id","kayit_zamani","sicaklik_deger"),
